...
class Deque():
    ...
    def remover_duplicatas(self):
        elemento = self.head
        duplicata = elemento.next
        while elemento is not None:
            duplicata = elemento.next
            while duplicata is not None:
                if duplicata.data == elemento.data:
                    if duplicata.next is not None:
                        duplicata.next.prev = duplicata.prev
                    duplicata.prev.next = duplicata.next
                duplicata = duplicata.next
